...
namespace Lanpuda.ERP.BasicData.Products.Selects.MultipleSelectWithSalesPrice
{
    public class ProductMultipleSelectWithSalesPriceViewModel : PagedViewModelBase<ProductWithPriceDto>
    {
        ...
        public ProductMultipleSelectWithSalesPriceViewModel(
        ...
        protected override async Task GetPagedDatasAsync()
        {
            ...
            {
                this.IsLoading = true;
                ProductWithSalesPricePagedRequestDto requestDto = new ProductWithSalesPricePagedRequestDto();
                ...
                {
                    requestDto.CustomerId = (Guid)this.CustomerId;
                }
                var result = await _productLookupAppService.GetPagedListWithSalesPriceAsync(requestDto);
